...
import { HoldrLogoIcon } from '@/components/holdr-logo'
import { Search, Share2, UserPlus, Film } from 'lucide-react'
import { Button } from '@/components/ui/button'
import Link from 'next/link'

export default function Integrations() {
    return (
        <section id="usecase" className="bg-background @container py-24">
            <div className="mx-auto max-w-2xl px-6">
                <IntegrationsIllustration />
                <div className="mx-auto mt-12 max-w-md text-balance text-center">
                    <h2 className="font-serif text-4xl font-medium">How Holdr Works</h2>
                    <p className="text-muted-foreground mb-6 mt-4">Create your account, search for movies using real posters and ratings, and share your watchlist with friends.</p>
                    <Button
                        variant="secondary"
                        size="sm"
                        asChild
        ...
        <div
            ...
            <div className="@lg:px-24 relative flex h-10 items-center justify-between px-12">
                ...
                <div className="border-foreground/15 rounded-full border border-dashed p-2">
                    <div className="bg-card shadow-black/6.5 ring-border relative flex h-8 items-center rounded-full px-3 shadow-sm ring">
                        <HoldrLogoIcon className="size-4" />
                    </div>
                </div>
                <div className="bg-card shadow-black/6.5 ring-border relative flex h-8 items-center rounded-full px-3 shadow-sm ring">
