...
function ShareContent() {
  ...
  return (
    <div className="min-h-screen bg-background">
      <Head>
        <title>{`${userName}'s Watchlist - Holdr`}</title>
        <meta property="og:title" content={`${userName}'s Watchlist - Holdr`} />
        <meta property="og:description" content={`${userName} shared ${movies.length} movie${movies.length !== 1 ? 's' : ''} with you on Holdr.`} />
        <meta property="og:image" content={`/share/og/${code}`} />
        <meta property="og:image:width" content="1200" />
        <meta property="og:image:height" content="630" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content={`${userName}'s Watchlist - Holdr`} />
        <meta name="twitter:description" content={`${userName} shared ${movies.length} movie${movies.length !== 1 ? 's' : ''} with you on Holdr.`} />
        <meta name="twitter:image" content={`/share/og/${code}`} />
      </Head>
